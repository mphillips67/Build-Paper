setwd("~/Dropbox/popbuild/Mark_Scripts/Haplotype_analysis/4B/")
...
#inputfile <- read.table("Inputfile_4.txt", header = TRUE)
#founderfile <- read.table("Founders_4.txt", header = FALSE)

inputfilename <- "Inputfile_4.txt" #name of input file
founderfile <- "Founders_4.txt" #name of founder file
data <- read.table("Inputfile_4.txt",header=T)
chr <- unique(data$CHROM)


#sbuilds
outdir <- "~/Dropbox/popbuild/Mark_Scripts/Haplotype_analysis/4B/SBUILD/"
poolroot <- "alt_YEE_rec_4S_12"    #pool you want to get haps for




#kbuilds
poolroot <- "alt_YEE_rec_4K_12"    #pool you want to get haps for
outdir <- "~/Dropbox/popbuild/Mark_Scripts/Haplotype_analysis/4B/KBUILD/"
