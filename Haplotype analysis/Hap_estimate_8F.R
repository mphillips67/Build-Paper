...
inputfilename <- "Inputfile_8.txt" #name of input file
founderfile <- "Founders_8.txt" #name of founder file
data <- read.table("Inputfile_8.txt",header=T)
chr <- unique(data$CHROM)

#k build
poolroot <- "alt_YEE_rec_8K_12"    #pool you want to get haps for
outdir <- "~/Dropbox/popbuild/Mark_Scripts/Haplotype_analysis/8B/KBUILD/"
...
#s buld
outdir <- "~/Dropbox/popbuild/Mark_Scripts/Haplotype_analysis/8B/SBUILD/"
poolroot <- "alt_YEE_rec_8S_12"    #pool you want to get haps for
for(i in 1:16){
