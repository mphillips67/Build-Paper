...
inputfilename <- "Inputfile_12.txt" #name of input file
founderfile <- "Founders_12.txt" #name of founder file

data <- read.table("Inputfile_12.txt",header=T)
chr <- unique(data$CHROM)

#K build
poolroot <- "alt_YEE_rec_12K_12"    #pool you want to get haps for
outdir <- "~/Dropbox/popbuild/Mark_Scripts/Haplotype_analysis/12B/KBUILD/"
...
#S build
poolroot <- "alt_YEE_rec_12S_12"    #pool you want to get haps for
outdir <- "~/Dropbox/popbuild/Mark_Scripts/Haplotype_analysis/12B/SBUILD/"
